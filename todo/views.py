...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'createtodo.html', {'form':TodoForm(), 'error':'Bad data received. Please try again.'})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'viewtodo.html', {'todo': todo, 'form':form, 'error':'Bad data received. Please try again.'})
